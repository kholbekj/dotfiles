...
let g:colors_name="watkek"
hi Normal guifg=#0b8c8c guibg=#000000
hi Comment guifg=#80a0ff guibg=NONE
hi Constant guifg=#386f73 guibg=NONE
hi String guifg=#ab71ab guibg=NONE
hi htmlTagName guifg=#ff0000 guibg=NONE
hi Identifier guifg=#40ffff guibg=NONE
hi Statement guifg=#aa4444 guibg=NONE
hi PreProc guifg=#ba29ba guibg=NONE
